...
export default function PressPage() {
  return (
    <>
      <PageHeader title="The Press" intro="Notes, essays, and reflections on print, editions, and the work of making." image="/images/press/press-index-glass-detail.png" imageAlt="Framed stained-glass editorial plate." />
